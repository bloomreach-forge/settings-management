...
public class SettingsPlugin extends AdminPanelPlugin {
    ...
    public IModel<String> getTitle() {
        return new ClassResourceModel("admin-settings-title",SettingsPlugin.class);
    }

    @Override
    public IModel<String> getHelp() {
        return new ClassResourceModel("admin-settings-title-help",SettingsPlugin.class);
    }

    @Override
    public PanelPluginBreadCrumbPanel create(final String componentId, final IBreadCrumbModel breadCrumbModel) {
        return new SettingsPanel(componentId, breadCrumbModel, getPluginContext(), getPluginConfig());
    }
}
