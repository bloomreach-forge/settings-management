...
public class UrlRewriterConfigModel extends LoadableDetachableConfigModel<UrlRewriterConfig> {

    protected UrlRewriterConfig load() {
        return new UrlRewriterConfig(getConfigNode(UrlRewriterConfig.CONFIGURATION_PATH));
    }
}
